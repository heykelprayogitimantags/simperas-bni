...
<main class="flex-1 overflow-y-auto p-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <form action="<?= base_url('user/store') ?>" method="POST" class="space-y-6">
            <?= csrf_field() ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="username" class="block text-sm font-medium text-gray-700 mb-2">
                            Username * <span class="text-gray-400 font-normal">(min. 3 karakter)</span>
                        </label>
                        <input 
                            type="text" 
                            id="username" 
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            value="<?= old('email') ?>"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                            placeholder="Contoh: budi@bni.co.id"
                        >
                    </div>
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                            Password * <span class="text-gray-400 font-normal">(min. 6 karakter)</span>
                        </label>
                        <input 
                            type="password" 
                            id="password" 
        ...
        <div class="flex items-start">
            ...
            <div class="text-sm text-blue-800">
                ...
                <ul class="list-disc list-inside space-y-1">
                    ...
                    <li>User baru akan langsung aktif setelah dibuat</li>
                    <li>Setelah dibuat, user dapat login dengan username dan password yang telah ditentukan</li>
                </ul>
            </div>
        </div>
    </div>
